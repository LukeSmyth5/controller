...
router.get('/ai/:id', (req, res) => {
    ...
    const wkrDirSrc = '/usr/app/src'
    let aiModules = {
        "test": `${wkrDirSrc}/${process.env.AI_TEST_ADDRESS}`,
        "regression": `${wkrDirSrc}/${process.env.AI_ADDRESS_1}`,
        "neurons": `${wkrDirSrc}/${process.env.AI_ADDRESS_2}`,
    }
